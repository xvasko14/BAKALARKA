...
@section('content')
    <div class="container" style="max-width:90%;">
        <div class="row">
            ...
            <form class="form-inline" action="{{ route('manager_statistics_redC.main')}}" method="get">
            ...
            <h1 class="NadpisTabulky" align="center">{{ __('message.mostr') }}</h1>
