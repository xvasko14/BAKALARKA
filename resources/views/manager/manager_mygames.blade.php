                            ...
                            <table id="rooms-table" class="table table-bordered table-striped table-condensed" border=1 width="400">
                                ...
                                @foreach($game as $key => $data)
                                    <tr>
                                        ...
                                        <td> <a style="color: #1d643b" href="{{route('manager.TeamsGame', $data->id)}}">{{ $data->id}}</a>
                                        <td> <a style="color: #1d643b" href="{{route('manager.TeamsGame.formation', $data->id)}}">{{ $data->id}}</a> </td>
