...
@section('content')
    ...
    <div id="content">
        ...
        <div class="container" style="max-width:80%; margin-top: 40px;">
            <h1 class="NadpisTabulky" align="center">{{ __('message.squadchoose') }}</h1>
            <form action="{{ route('manager.PlayerInGame.insertGame', $game->id) }}" method="post">
                ...
                {{--<div class="Row" >--}}
                    {{--<div class="Column">--}}
                        {{--{{ csrf_field()}}--}}
                        {{--<label for="nahradnik1"><b>{{ __('message.bench1') }} 1.</b></label>--}}
                ...
                {{--<div class="Row" >--}}
                    {{--<div class="Column">--}}
                        {{--{{ csrf_field()}}--}}
                        {{--<label for="nahradnik5"><b>{{ __('message.bench1') }} 5.</b></label>--}}
